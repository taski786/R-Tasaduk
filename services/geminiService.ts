...
export const generateHugImage = async (
  ...
  **Style and Mood:**
  ...
  try {
    ...
    // Fallback for other errors - include the actual error message for debugging
    throw new Error(`An unexpected error occurred: ${error.message || JSON.stringify(error)}`);
  }
};
